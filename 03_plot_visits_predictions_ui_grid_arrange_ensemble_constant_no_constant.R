...
## Author: User                                                      ##
## Date: 12/5/2022                                                     ##
## Purpose: Plot visit predictions and past trends in Peru in Mexico, constant and no constant                           ##
################################################################################
## clear memory
rm(list=ls())
...
predict_df <- fread(file.path(dir, 'visits_plotting_predictions_no_constant.csv'))
...
ggsave(file.path(dir, "visits_predictions_no_constant.jpg"),y, height = 12, width = 12)
