## Author: USER                                                   ##
## Purpose: Predict 2019 CHE using level ~ lag level, unweighted, no constant               ##
################################################################################
## clear memory
rm(list=ls())
...
# Model 2: level ~ lag level (unweighted)
...
#Peru 
per_5_che10 <- lm(che10 ~ lag_che -1 , data = che10_df[ihme_loc_id == "PER" & year_id %nin% c(2019,2020)])
per_5_che25 <-lm(che25 ~ lag_che-1, data = che25_df[ihme_loc_id == "PER" & year_id %nin% c(2019,2020)])

#Mexico
mex_5_che10 <- lm(che10 ~ lag_che-1, data = che10_df[ihme_loc_id == "MEX"& year_id %nin% c(2018,2020)])
mex_5_che25 <- lm(che25 ~ lag_che-1, data = che25_df[ihme_loc_id == "MEX"& year_id %nin% c(2018,2020)])

#Belarus
bel_5_che10 <- lm(che10 ~ lag_che-1, data = che10_df[ihme_loc_id == "BLR"& year_id %nin% c(2019,2020)])
bel_5_che25 <-  lm(che25 ~ lag_che-1, data = che25_df[ihme_loc_id == "BLR"& year_id %nin% c(2019,2020)])

#Russia
rus_5_che10 <- lm(che10 ~ lag_che-1, data = che10_df[ihme_loc_id == "RUS"& year_id %nin% c(2014,2020)])
rus_5_che25 <-  lm(che25 ~ lag_che-1, data = che25_df[ihme_loc_id == "RUS"& year_id %nin% c(2014,2020)])

#Vietnam.
vnm_5_che10 <- lm(che10 ~ lag_che-1, data = che10_df[ihme_loc_id == "VNM"& year_id %nin% c(2018,2020)])
vnm_5_che25 <-  lm(che25 ~ lag_che-1, data = che25_df[ihme_loc_id == "VNM"& year_id %nin% c(2018,2020)])
...
#Peru
#CHE 10
peru_che10_predict <- predict_most_recent_2020_uncertainty(che10_df_predict_5_years_per, per_5_che10, "che10_predict", 2019)

#CHE 25
peru_che25_predict <- predict_most_recent_2020_uncertainty(che25_df_predict_5_years_per, per_5_che25, "che25_predict", 2019)

#Mexico
#CHE 10
mexico_che10_predict <-  predict_most_recent_2020_uncertainty(che10_df_predict_5_years_mex, mex_5_che10, "che10_predict", 2018)

#CHE 25
mexico_che25_predict <-  predict_most_recent_2020_uncertainty(che25_df_predict_5_years_mex, mex_5_che25, "che25_predict", 2018)

#Belarus
#CHE 10
belarus_che10_predict <-predict_most_recent_2020_uncertainty(che10_df_predict_5_years_blr, bel_5_che10, "che10_predict", 2019)

#CHE 25
belarus_che25_predict <-  predict_most_recent_2020_uncertainty(che25_df_predict_5_years_blr, bel_5_che25, "che25_predict", 2019)

#Russia
#CHE 10
russia_che10_predict <- predict_most_recent_2020_uncertainty(che10_df_predict_5_years_rus, rus_5_che10, "che10_predict", 2014)

#CHE 25
russia_che25_predict <-  predict_most_recent_2020_uncertainty(che25_df_predict_5_years_rus, rus_5_che25, "che25_predict", 2014)

#Vietnam
#CHE 10
vietnam_che10_predict <- predict_most_recent_2020_uncertainty(che10_df_predict_5_years_vnm, vnm_5_che10, "che10_predict", 2018)

#CHE 25
vietnam_che25_predict <- predict_most_recent_2020_uncertainty(che25_df_predict_5_years_vnm, vnm_5_che25, "che25_predict", 2018)
...
#save CSV's 
write.csv(che10_compare,'FILEPATH/che10_compare_model2_unweighted_no_constant.csv', row.names = F)

write.csv(che25_compare,'FILEPATH/che25_compare_model2_unweighted_no_constant.csv', row.names = F)
