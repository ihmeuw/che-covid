## Author: User                                                      ##
## Date: 11/10/2022                                                       ##
## Purpose: Create draws of distribution of mean for each country and each che driver   ##
...
## save draws 
write.csv(che_driver_draws,file.path(dir, 'che_driver_draws.csv'), row.names = F)
